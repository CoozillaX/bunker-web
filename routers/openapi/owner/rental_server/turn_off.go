...
//	@Param			Request			body		TurnOffRequest			true	"请求时需要在 Body 携带以下查询参数"
//	@Success		200				{object}	giner.BasicResponse	"成功时返回"
//	@Router			/openapi/owner/rental_server/turn_off [post]
func (*RentalServer) TurnOff(c *gin.Context) {
	// Parse request
	...
	// Try to turn off rental server
	ginerr = g79.TurnOffRentalServer(gu, req.ServerCode, time.Second*20)
	if ginerr != nil {
		c.Error(ginerr)
		return
	}
