...
func (*BindAccount) QRCode(c *gin.Context) {
	...
	if usr.HelperMpayUser == nil || usr.HelperMpayUser.GetType() != models.MpayUserTypeWindows {
	...
	// Try to login
	if protocolErr := usr.HelperMpayUser.QRCodeLoginByUUID(req.UUID); protocolErr != nil {
